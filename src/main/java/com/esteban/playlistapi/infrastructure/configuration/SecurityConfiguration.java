...
/**
 * Configuración centralizada de Spring Security 6 para la capa Infrastructure.
 * Configura el filtro de seguridad, la gestión de sesiones Stateless y los Beans de encriptación.
 */
@Configuration
@EnableWebSecurity
